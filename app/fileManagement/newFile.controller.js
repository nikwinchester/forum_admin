"use strict";
angular.module('forum').controller('newFileCtrl',
    ["$scope", "$uibModalInstance", "items", "toastr","$http","$state","Upload",
        function ($scope, $uibModalInstance, items, toastr,$http,$state,Upload) {
            ...
            $scope.submitFile=function(){
                ...
                {
                    $http.post(SERVER_URL +"/admin/updateFile",$scope.file)
                        ...
                        .catch(function(error){
                            ...
                            console.log(toastr.error(error.data.err));
                        });
                }
            };

            $scope.deleteFile=function(){
                $http.post(SERVER_URL+"/admin/deleteFile",$scope.file)
                    .then(function(response){
                        toastr.info("删除成功");
